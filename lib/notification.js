...
const QUEUE_NAME = 'PlaygroundMessageProcessorQueue';
...
module.exports = class Notification {
	...
	async send(notification, clientCode) {
		...
		const command = new SendMessageCommand({
			...
			MessageAttributes: {
				...clientCode && {
					'janis-client': this.buildStringAttribute(clientCode)
				},
				service: this.buildStringAttribute(this.serviceName)
			}
		});
	...
	buildStringAttribute(stringValue) {
		return {
